<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{asset('css/v_1/reset.css?v=27')}}">
        <link rel="stylesheet" href="{{asset('css/v_1/mainCss.css?v=22')}}">
        <link rel="stylesheet" href="{{asset('css/v_1/globals_pc.css?v=9')}}">
        <link rel="stylesheet" href="{{asset('css/v_1/globals_mobile.css?v=52')}}">
        @yield('css')
